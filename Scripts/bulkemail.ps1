$file = import-csv C:\temp\bulkmail1.csv
...
For your computer to function properly and safely, it requires a minimum amount of free disk space, not only to properly handle the file system itself, but it also needs some disk space to be able to update virus definitions or to install service packs and security patches.
...
#echo $comp
         ...
         #Send-MailMessage -To "karthik.t2@unisys.com"  -From "Thyagaraju, Karthik <karthik.t2@in.unisys.com>" -cc "vijay.verdia@unisys.com","karthik.t2@in.unisys.com" -Subject "Urgent Action Required - Low Disk Space " -Body $body -BodyAsHtml   -SmtpServer NA-MAILRELAY-T3.na.uis.unisys.com
