...
$drsGroup = Get-DrsClusterGroup -Name "RHEL-APD-VM"
$RHEL = Get-VM -Location "NTX-APD" | sort | where {$_.Guest -like "*Red Hat Enterprise Linux*"} | select name,@{N="Configured OS";E={$_.ExtensionData.Config.GuestFullname}}
